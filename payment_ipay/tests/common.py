...
class iPayCommon(PaymentCommon):

    @classmethod
    def setUpClass(cls):
        super().setUpClass()

        cls.ipay = cls._prepare_provider('ipay', update_values={
            'ipay_website_key': 'dummy',
            'ipay_secret_key': 'test_key_123',
        })

        # Override defaults
        cls.provider = cls.ipay
